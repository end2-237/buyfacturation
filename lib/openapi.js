export const openApiSpec = {
  ...
  tags: [
    ...
    { name: "Paiements", description: "Paiement mobile money (PawaPay) et transactions" },
  ],
  paths: {
    "/api/invoices/{id}/pay": {
      post: {
        ...
        description: "Crée une transaction et déclenche un push USSD via PawaPay. Le montant et la devise viennent de la facture.",
        ...
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                required: ["numero", "operateur"],
                properties: {
                  numero: { type: "string", description: "Numéro mobile money (local ou MSISDN)", example: "698786857" },
                  operateur: { type: "string", enum: ["MTN", "ORANGE"] },
                  source: { type: "string", description: "Origine du paiement", example: "facture_manuelle" },
                },
              },
            },
          },
        ...
        responses: {
          200: {
            description: "Paiement initié — en attente de validation sur le téléphone",
            content: { "application/json": { schema: { type: "object", properties: { transactionId: { type: "string" }, providerTxId: { type: "string" }, statut: { type: "string" }, message: { type: "string" } } } } },
          },
          ...
          409: { description: "Facture déjà payée", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } },
          502: { description: "Échec côté provider", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } },
        },
      },
    },
    "/api/transactions/{id}/status": {
      get: {
        tags: ["Paiements"],
        summary: "Statut d'une transaction (polling)",
        description: "Renvoie le statut courant ; réconcilie auprès du provider si encore en attente.",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string", format: "uuid" } }],
        responses: {
          200: { description: "Statut", content: { "application/json": { schema: { type: "object", properties: { statut: { type: "string", enum: ["PENDING", "ACCEPTED", "COMPLETED", "FAILED", "EXPIRED"] } } } } } },
    ...
    "/api/webhooks/pawapay": {
      post: {
        tags: ["Paiements"],
        summary: "Webhook de confirmation PawaPay",
        description: "Appelé par PawaPay. Source de vérité du paiement : met à jour la transaction et la facture liée.",
        requestBody: { content: { "application/json": { schema: { type: "object", properties: { depositId: { type: "string" }, status: { type: "string" }, amount: { type: "string" }, currency: { type: "string" } } } } } },
        responses: { 200: { description: "Reçu", content: { "application/json": { schema: { type: "object", properties: { received: { type: "boolean" } } } } } } },
      },
    },
    "/api/invoices": {
      get: {
        ...
        parameters: [
          { name: "type", in: "query", schema: { type: "string", enum: ["standard", "abonnement", "bon_commande", "recu"] }, description: "Filtrer par type" },
  ...
  components: {
    schemas: {
      ...
      InvoiceInput: {
        ...
        properties: {
          type: { type: "string", enum: ["standard", "abonnement", "bon_commande", "recu"] },
