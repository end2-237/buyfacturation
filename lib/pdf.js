  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <Text style={[s.bold, { fontSize: 22, color: C.orange, marginBottom: 12 }]}>
          {IS_ORDER(inv) ? "BON DE COMMANDE" : "FACTURE"}
        </Text>

        <View style={[s.row, { marginBottom: 14 }]}>
          <View style={{ flex: 1, paddingRight: 10 }}>
            <Text style={[s.label, { color: C.orange, marginBottom: 4 }]}>
        ...
        <View style={s.noteBox}>
          <Text>
            ...
            <Text style={[s.bold, { color: C.darkOrange }]}>{numberToWords(Math.round(subtotal))} francs CFA</Text>.
          </Text>
        </View>
